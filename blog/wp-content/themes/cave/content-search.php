<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <?php $entry_title = ( 'page' == get_post_type() && cave_post_edit_link() == '' )? 'entry-title entry-title-page' : 'entry-title'; ?>
  ...
  <?php elseif ( 'page' == get_post_type() && cave_post_edit_link() != '' ) : ?>  
  <div class="entry-meta"> 
    <?php echo cave_post_edit_link(); ?> 
  </div>  
  <?php endif;?>
